 ...
 * This is used to compensate offset, temperature dependence and other parameters of the sensor.
 */
static void s_read_calibration_data(int fd, bmp180_data_st *bmp180) {
...
static long s_read_raw_temperature(bmp180_data_st *bmp180) {
    int MSB, LSB;
    long UT;
...
static long s_read_raw_pressure(bmp180_data_st *bmp180) {
 ...
 */
double bmp180_read_temperature(bmp180_data_st *bmp180) {
    long UT, temp;
    long X1, X2, B5;
...
long bmp180_read_pressure_altitude(bmp180_data_st *bmp180, double *altitude) {
    long UT, UP, pressure;
...
bmp180_data_st *bmp180_module_init(short OSS) {
    ...
    bmp180_data_st *data = (bmp180_data_st *)malloc(sizeof(bmp180_data_st));
    if (data == NULL)
        exit(ENOMEM);
...
void bmp180_module_fini(bmp180_data_st *bmp180) {
    if (bmp180 != NULL) {
        close(bmp180->fd);
        free(bmp180);
        bmp180 = NULL;
